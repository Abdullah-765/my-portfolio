...
export default function Navbar() {
    return (
      <div className="mt-[40px] font-bold text-[16px] md:text-[22px] justify-self-center flex border-black border-3 w-[80%] flex-row justify-around py-[10px] h-fit text-black items-center bg-amber-400 shadow-custom">
